package github.kamemak.ajpegtran_turbo_example;
...
public class MainActivity extends AppCompatActivity {
    ...
    static final int JCS_MAX=6;		/* Values greater than this are not used for jpegtran. */
                        ...
                        if(result.getResultCode() == RESULT_OK ){
                            ...
                            if(data != null) {
                                ...
                                if (jniresult.startsWith("OK")) {
                                    ...
                                    String []color_space_str = {"Unknown","Grayscale","RGB","YCbCr","CMYK","YCbCrK"};
                        ...
                        if(result.getResultCode() == RESULT_OK ){
                            ...
                            if(data != null) {
                                ...
                                try {
                                    ...
                                    // Another operation can execute with changing the option string.
